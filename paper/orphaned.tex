...
For any single-path MPI program, \textit{ctp}, a deadlock detected by \algoref{algo:vorphaned} is a real deadlock existing for a instance of the orphaned receive pattern, $\mathit{pt}$. 
