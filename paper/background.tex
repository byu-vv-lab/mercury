...
A barrier \barrier\ is also associated with an identifier that is unique for its communicator. A communicator identifies a group of barriers. The barriers synchronize \textit{ctp} by blocking the program execution until all the members in the same group are witnessed.
